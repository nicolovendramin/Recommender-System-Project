...
print("Technique : Item Based Collaborative Filtering")
o_file.write("Technique : Item Based Collaborative Filtering")
...
# TODO remove double normalization
user_rating_matrix = normalize(user_rating_matrix_non_normalized, 'l2', 1, copy=True)  # normalize by row
user_rating_matrix = normalize(user_rating_matrix_non_normalized, 'l2', 0, copy=True)  #normalize by column
