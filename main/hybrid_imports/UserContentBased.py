...
def print_run_details():
    ...
    print("Technique : Content Based User Filtering")
    o_file.write("Technique : Content Based User Filtering\n")
...
def rec(argos):
    ...
    return rec_dictionary, target_users, removed_ratings_per_user, calculated_map, "Content Based User Filtering"
