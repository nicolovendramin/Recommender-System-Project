...
def recommend():
    ...
    csr_user_rating_matrix = sps.csr_matrix(user_rating_matrix)
    U , V = FunkSVD_sgd(csr_user_rating_matrix)
    ...
    for target_user in target_users:
        ...
        if target_user in user_rated_items.keys():
            ...
            estimated_ratings = U.getrow(position).dot(V.T.todense()).tolist()[0]
